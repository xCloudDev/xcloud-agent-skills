...
|---|---|
| Mailboxes and mail delivery (plans, purchase, DNS, IMAP/POP/SMTP) | `references/domain/addons.md` |
...
| Server plans this team can buy | `servers.plans` | `GET /servers/plans` (buying: the `servers` skill) |
