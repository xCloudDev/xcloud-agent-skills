...
- `reference/auth.md`
- `reference/conventions.md` — including **Proactive mode**
...
|---|---|
| Git deploys: detect, dry run, deploy keys, Docker ports, polling, diagnosis and retry, redeploys | `reference/deploy-git.md` |
| One-click apps: catalog, compatibility, install, credentials, start/stop/redeploy | `reference/deploy-one-click-apps.md` |
| Staging environments for Git sites; new WordPress sites | `reference/deploy-staging-and-wordpress.md` |
...
| "It's a private repo" | The playbook — detect first; a connected provider or a deploy key clears access (`reference/deploy-git.md`) |
...
| "Staging of the API site from feature/checkout" | `sites_stagingSites_create` (Git sites only — `reference/deploy-staging-and-wordpress.md`) |
| "Install Ghost / Uptime Kuma / Vaultwarden" | One-click flow (`reference/deploy-one-click-apps.md`) |
| "New WordPress site called Northwind" | WordPress create with a dry run (`reference/deploy-staging-and-wordpress.md`) |
