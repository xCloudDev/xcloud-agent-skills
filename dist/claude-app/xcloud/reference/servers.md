...
|---|---|
| Buying/connecting a server, stacks, catalog & pricing | `reference/servers-provisioning.md` |
...
| Databases & database users ⚠️ _(deprecated — withheld from the API, see file)_ | `reference/servers-databases.md` |
