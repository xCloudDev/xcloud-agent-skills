...
> `https://app.xcloud.host/mcp` → sign in with OAuth. One tool per
> authenticated API operation plus two search tools, full API parity,
> per-action confirmation on destructive operations.
